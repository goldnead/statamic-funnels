 ...
 *
 * `insights-table-metric.php` beside this one carries the base class the
 * metrics extend and must be required **after** this file — it implements
 * `Metric` and cannot be declared before the interface exists.
 *
